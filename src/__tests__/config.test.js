const mockConfig = (config) => {
  // doMock is not hoisted to the top, which means we can mock the module/ on a per-test basis.
  // Jest does not return mock objects for these types of static file modules.
  jest.doMock("../auth_config.json", () => ({
...
describe("The config module", () => {
  ...
  it("should omit the audience if left at a default value", () => {
    mockConfig({ audience: process.env.REACT_APP_API_IDENTIFIER });
